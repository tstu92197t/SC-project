...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	"""
	:param order: an integer, Controls the order of Sierpinski Triangle
	:param length: an integer, The length of order 1 Sierpinski Triangle
	:param upper_left_x: an integer, The upper left x coordinate of order 1 Sierpinski Triangle
	:param upper_left_y: an integer, The upper left y coordinate of order 1 Sierpinski Triangle
